...
| **24** | **RAG retrieval system** — embeddings + farm-scoped retrieval API (+ optional LLM synthesis); **starts after Phase 23 exit**; builds on [20.95 RAG-prep](docs/plans/phase_20_95_rag_prep_and_housekeeping.plan.md) | ⏳ Planned | [plan](docs/plans/phase_24_rag_retrieval_system.plan.md) |

**In flight / next up** (priority order):

- [ ] **Phase 23 — stabilization** — [`docs/plans/phase_23_stabilization_sprint.plan.md`](docs/plans/phase_23_stabilization_sprint.plan.md): tests + `make audit-openapi` + docs + small fixes only; exit checklist unlocks Phase 24.
- [ ] **Phase 24 — RAG system** — [`docs/plans/phase_24_rag_retrieval_system.plan.md`](docs/plans/phase_24_rag_retrieval_system.plan.md): real retrieval (vectors + API + consent boundaries); **not** the same as 20.95 schema prep alone.
...
- [ ] **Phase 21** — ship cycle summary / compare / UI / CSV per [`docs/plans/phase_21_crop_cycle_analytics.plan.md`](docs/plans/phase_21_crop_cycle_analytics.plan.md) (distinct from 20.7 cost-summary).
