...
**Planned (Phase 32):** conversational **grow setup** PR bundles (plant + cycle + fertigation from chat) + platform doc RAG — [plan](docs/plans/phase_32_guardian_grow_setup_prs.plan.md).

**Planned (Phase 33):** Guardian read-tool hardening, `context_ref` dedup, hardware CI lane, enterprise site manifest — [plan](docs/plans/phase_33_guardian_polish_and_enterprise_ops.plan.md) (run **WS1** before or beside Phase 32).
...
- [ ] **Phase 33 — Guardian polish & enterprise ops** — WS1 read-tool hardening (optional before 32) — [plan](docs/plans/phase_33_guardian_polish_and_enterprise_ops.plan.md)
...
- [ ] Phase 33 — Guardian polish & enterprise ops (read-tool hardening, site manifest) — [plan](docs/plans/phase_33_guardian_polish_and_enterprise_ops.plan.md)
