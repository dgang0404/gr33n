...
| `make e2e-browser` (needs `make dev-auth-test`) | **Phase 211.07** — browser Confirm/Dismiss on Pending tab | Playwright seeds via `POST /v1/chat/proposals/seed-pending` (dev/auth_test); **no LLM** — see [e2e/README.md](../e2e/README.md) |
