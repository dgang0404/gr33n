...
| `GUARDIAN_EVAL_PROMPT_COOLDOWN_SECONDS` | `60` on cpu-16gb / unset profile; else `0` | Pause between eval prompts (Phase 211.06). Set `0` to disable. Slow turns (≥20m) bump cool-down to ≥90s. |
