...
**Related:** [INSTALL.md](../INSTALL.md) · [local-operator-bootstrap.md](local-operator-bootstrap.md) (daily cheat sheet) · [farm-guardian-ollama-setup.md](farm-guardian-ollama-setup.md) · [Phase 126 plan](plans/archive/phase_126_guardian_cpu_efficiency.plan.md)
