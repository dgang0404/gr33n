...
| Phase 112 — Guardian Ollama hardening (plan) | [`plans/phase_112_guardian_ollama_hardening.plan.md`](plans/phase_112_guardian_ollama_hardening.plan.md) — auto-pull, `/api/show` context, CI E2E smokes |
