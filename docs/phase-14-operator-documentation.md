...
Hub: [`phase_68_73_spa_workspace_roadmap.plan.md`](plans/phase_68_73_spa_workspace_roadmap.plan.md) (covers **68–77** formally; **78–81** are post-arc UI polish on `main`). **UI arc shipped** through Phase 81; Phases **71–73** remain for feed/water, money, and Guardian PR discoverability. Closure for 68+ lives in each phase plan + arc hub OC table + Vitest `phase-*-closure.test.js` files.
...
| SPA workspace arc 68–81 (UI shipped; 71–73 planned) | [`plans/phase_68_73_spa_workspace_roadmap.plan.md`](plans/phase_68_73_spa_workspace_roadmap.plan.md) · [operator tour §7e–§7j](operator-tour.md#7e-workspaces--sidebar-jobs-tabs-inside-phase-68) |
