...
| Phase 125 — Pi LED simulation rig (in progress) | [`plans/phase_125_pi_sensor_actuator_light_simulation.plan.md`](plans/phase_125_pi_sensor_actuator_light_simulation.plan.md) · WS1 ✅ [`pi-light-simulation-mapping.md`](pi-light-simulation-mapping.md) · WS2–WS3 ✅ `light_simulation.py`, `synthetic_sensors.py`, `nudge_sensor.py` |
