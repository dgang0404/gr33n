...
| **36** | Greenhouse climate — shade/vents/fans; Guardian **`summarize_zone_greenhouse_climate`** (**shipped** — backend + OC-36B docs; **Climate** tab via Phase 38; OC-36C smokes + WS6 sensor interlocks open) | [`phase_36_greenhouse_climate.plan.md`](plans/phase_36_greenhouse_climate.plan.md) · [operator-tour §5b](operator-tour.md#5b-greenhouse-shade-vents-and-fans-phase-36) · [architecture §7.0c](farm-guardian-architecture.md) |
...
Rollup: [`phase_35_37_operational_closure.plan.md`](plans/phase_35_37_operational_closure.plan.md) (now spans **35–39**). After operator-doc edits, re-ingest Guardian RAG: **`make rag-ingest-platform-docs`** and **`make rag-ingest-field-guides`** (Phase 37 field corpus).
...
| Phase 36 — Greenhouse climate (plan) | [`plans/phase_36_greenhouse_climate.plan.md`](plans/phase_36_greenhouse_climate.plan.md) — Climate tab + §5b; OC-36C smokes pending |
...
| Phase 35–39 operational closure | [`plans/phase_35_37_operational_closure.plan.md`](plans/phase_35_37_operational_closure.plan.md) — OC-35/36/38 doc closure; OC-36C + Phase 39 implementation |
