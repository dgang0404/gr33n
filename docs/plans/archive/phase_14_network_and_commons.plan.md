...
- **Implementation** belongs primarily in **[`docs/plans/archive/phase_15_farm_onboarding.plan.md`](phase_15_farm_onboarding.plan.md)** — parameterized, idempotent apply per `farm_id`, optional org-level default.
...
Reference `@docs/plans/archive/phase_14_network_and_commons.plan.md` and **`@docs/phase-14-operator-documentation.md`**; pick the next row in the remaining-work queue or adjust todos to match your release train.
