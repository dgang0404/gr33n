...
Reference `@docs/plans/archive/phase_15_farm_onboarding.plan.md` and `@docs/plans/archive/phase_14_network_and_commons.plan.md` (WS9) together when scoping farm creation work. For Insert Commons integration pitfalls (custom POST bodies), point integrators at `@docs/insert-commons-pipeline-runbook.md` § *Custom senders*.
