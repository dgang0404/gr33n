...
> Implement Phase 35 from `docs/plans/archive/phase_35_lighting_domain.plan.md`. Start WS1 schema + transactional schedule pair generation, then WS4 timezone fix. Build PhotoperiodClockEditor fresh (Start/End/Duration linked) — do not port dgang0404 Vuex code. Presets: peas 22/2, veg 18/6, flower 12/12.
