...
> Read `docs/plans/archive/phase_49_sidebar_nav_polish.plan.md`. Implement one workstream (WS1–WS4). UI-only; do not change route paths or schema. Honor prefers-reduced-motion. Keep "fertigation" out of farmer grow paths.
