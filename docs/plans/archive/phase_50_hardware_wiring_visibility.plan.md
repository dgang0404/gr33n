...
> Read `docs/plans/archive/phase_50_hardware_wiring_visibility.plan.md`. Phase 50 is **shipped** (OC-50 closed). For Pi live config pull, start **Phase 51** (`phase_51_pi_config_sync.plan.md`).
