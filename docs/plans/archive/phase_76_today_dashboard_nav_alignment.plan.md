...
> Read `docs/plans/archive/phase_76_today_dashboard_nav_alignment.plan.md`. After 71–75 redirects ship, sweep Dashboard.vue + mobileBottomNav + morning chips so no widget links to retired routes. UI-only.
