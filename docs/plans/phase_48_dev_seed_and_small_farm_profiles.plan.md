...
> Read `docs/plans/phase_48_dev_seed_and_small_farm_profiles.plan.md`. Implement one workstream (WS1–WS7). Prefer migrations + scripts over UI. Gate destructive ops behind dev env flags. Do not change production retention without runbook update.
