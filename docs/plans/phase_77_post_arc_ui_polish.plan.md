...
> Read `docs/plans/phase_77_post_arc_ui_polish.plan.md`. Final arc polish: analytics home, Guardian nav policy, optional help hub, farm config card, Settings trim. Verify ~8-item sidebar.
