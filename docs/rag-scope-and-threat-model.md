...
**Suggested implementation order for domains marked Yes:** tasks → automation runs → **crop cycles** → **fertigation programs** (`source_type` **`fertigation_program`**) → remainder per product after §4.2 gates.
