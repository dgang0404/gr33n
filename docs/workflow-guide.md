...
| **[47 — Feeding & water](plans/phase_47_feeding_water_plain_language.plan.md)** ✅ | **`/feeding`** hub + zone **Water** feeding plan — room-first, no six-tab console | Daily grow watering job; Advanced **Feeding (technical)** for power users. Walkthrough: [operator-tour §7b](operator-tour.md#7b-feeding--water-for-this-room-phase-47). |
| **[42 — Comfort & automation](plans/phase_42_comfort_targets_automation_plain_language.plan.md)** ✅ | **Targets** nav; comfort bands; plain schedules/rules | Operators set bands without opening Setpoints table first. Walkthrough: [operator-tour §5c](operator-tour.md#5c-comfort-bands--what-runs-when-phase-42--shipped). |
| **[43 — Operations hub](plans/phase_43_operations_stock_feeding_finance.plan.md)** ✅ | **Operations → Supplies / Feeding (details) / Money** — restock, farm-wide feeding admin, receipts | Replaces schema-first Inventory/Fertigation/Costs in farmer nav; Advanced keeps full editors. Walkthrough: [operator-tour §7](operator-tour.md#7-supplies-feeding--money-phase-43). |
