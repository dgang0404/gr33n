...
Vision analysis (operator attached zone reference photo(s)) — Phase 67 field assistant:
...
- When a crop profile block is present, name the crop and stage and tie deficiency patterns to profile EC/pH/DLI targets (e.g. interveinal yellowing on older leaves → magnesium hypothesis when pH/EC context fits).
