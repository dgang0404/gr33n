<template>
  <section class="md:hidden space-y-3" data-test="farm-zone-stack">
    <div>
      <h3 class="text-xs font-semibold text-gray-500 uppercase tracking-widest">Your zones</h3>
      <p class="text-[11px] text-zinc-500 mt-0.5">Tap a zone for quick actions.</p>
    </div>
