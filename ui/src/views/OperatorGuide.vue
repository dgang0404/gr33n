  ...
  <div :class="embedded ? 'p-4 sm:p-6 max-w-3xl mx-auto space-y-10 pb-24 md:pb-10' : 'p-4 sm:p-6 max-w-3xl mx-auto space-y-10 pb-24 md:pb-10'">
    ...
    <section class="bg-zinc-900 border border-zinc-800 rounded-xl p-5 space-y-3">
      ...
      <ol class="list-decimal list-inside space-y-2 text-sm text-zinc-300">
        ...
        <li>
          <router-link v-nav-hint="'/plants'" class="text-gr33n-400 hover:underline" to="/plants">Plants</router-link>
          · <router-link v-nav-hint="'/operations/supplies'" class="text-gr33n-400 hover:underline" to="/operations/supplies">Supplies</router-link>
          · <router-link v-nav-hint="'/operations/money'" class="text-gr33n-400 hover:underline" to="/operations/money">Money</router-link>
      ...
      <p class="text-xs text-zinc-600 pt-2">
        ...
        <router-link v-nav-hint="'/plants'" class="text-gr33n-500 hover:underline" to="/plants">Plants → Start a grow</router-link>;
        <strong class="text-zinc-400">Harvest weigh-in</strong> on the zone strip → post-harvest compare;
        <router-link v-nav-hint="'/operations/supplies'" class="text-gr33n-500 hover:underline" to="/operations/supplies">Supplies → + Add qty</router-link> to restock;
        <router-link v-nav-hint="'/operations/money'" class="text-gr33n-500 hover:underline" to="/operations/money">Money → Save receipt</router-link> (tag to room/grow).
      </p>
      <p class="text-xs text-zinc-600 pt-2">
